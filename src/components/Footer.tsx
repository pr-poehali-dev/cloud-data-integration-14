...
export default function Footer() {
  return (
    <>
      ...
      <section id="story" className="bg-[#3C096C] py-24 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          >
            <p className="text-[#FFC880] text-sm font-semibold uppercase tracking-widest mb-8">История</p>
            ...
            <p className="text-white/40 text-base italic">
              ...
              <span className="text-[#FFC880] not-italic font-semibold">Пуфыч — помощник, который ведёт вас дальше.</span>
            </p>
          </motion.div>
        </div>
      </section>
      ...
      >
        <div className="relative h-[calc(100vh+640px)] -top-[100vh]">
          <div className="h-[640px] sticky top-[calc(100vh-640px)]">
            <div className="bg-[#faf8ff] h-full w-full flex flex-col">
              {/* CTA */}
              <div className="flex-1 flex flex-col items-center justify-center px-6 py-16 text-center">
                ...
                >
                  ...
                  <h2 className="text-4xl md:text-5xl font-bold text-[#3C096C] mb-5 text-balance">
                    Начните с одного простого шага.
                  </h2>
                  <p className="text-[#5A189A]/70 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
                    Создайте профиль питомца, а Пуфыч подскажет, с чего начать: питание, здоровье, поведение или покупки.
                  </p>
                  <div className="flex flex-wrap gap-4 justify-center">
                    <button className="bg-[#FF9100] text-white font-bold px-8 py-4 rounded-2xl hover:bg-[#e07f00] transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-[#FF9100]/30 text-base">
                      Создать профиль питомца
                    </button>
                    <button className="border-2 border-[#9D4EDD]/40 text-[#5A189A] font-semibold px-8 py-4 rounded-2xl hover:border-[#5A189A] hover:bg-[#5A189A] hover:text-white transition-all duration-300 text-base">
              ...
              {/* Footer bottom */}
              <div className="bg-[#3C096C] py-6 px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-4">
